...
<<<<<<<< HEAD:MEDIDATA_Lab_Serv/frontend/admin/escritorio.php
    <link href="<?php echo medidata_asset('/backend/vendor/boxicons/css/boxicons.min.css'); ?>" rel="stylesheet">
========
    <link href='/backend/vendor/boxicons/css/boxicons.min.css' rel='stylesheet'>
>>>>>>>> chore/rrhh-interviews:MEDIDATA_Lab_Serv/uploads/frontend/admin/escritorio.php
...
<body>
    <div class="dashboard-container">
        ...
        <div class="dashboard">
            ...
            <div class="card">
                <h2>Ventas Este Año <?php echo date('Y'); ?></h2>
            ...
            <div class="card">
                ...
                <p><?php echo number_format($totalCuentas); ?></p>
            </div>
<div class="card">
    <h2>Total MH-PACS</h2>
...
<div class="card">
    <h2>Marcajes Hoy</h2>
    <p><?php echo number_format($biometricMarcasHoy); ?></p>
</div>
...
function generarInformeCierreCaja() {
    ...
    const url = `../../backend/registros/cierre_caja_pdf.php?fecha_desde=${fechaDesde}&fecha_hasta=${fechaHasta}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('fechaDesde').value = hace30DiasString;
});
</script>
...
<div class="dashboard-container">
    <header>
        <h1>Solicitud de Dietas Hospitalarias</h1>
    </header>

    <div class="dashboard-summary">
        <div class="summary-card" id="total-solicitudes">
            <h3>Total de Solicitudes</h3>
            <p><?php echo number_format($total_solicitudes); ?></p>
        </div>
        <div class="summary-card" id="solicitudes-entregadas">
            <h3>Entregadas</h3>
            <p><?php echo number_format($solicitudes_entregadas); ?></p>
        </div>
        <div class="summary-card" id="solicitudes-pendientes">
            <h3>Pendientes</h3>
            <p><?php echo number_format($solicitudes_pendientes); ?></p>
        </div>
    </div>
</div>
