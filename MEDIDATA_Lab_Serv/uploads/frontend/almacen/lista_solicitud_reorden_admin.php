    ...
    <table id="example" class="display responsive-table" style="width:100%">
        ...
        <tbody>
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo '<td data-title="Fecha Autorización">' . htmlspecialchars($row['fecha_autorizacion']) . '</td>';
                echo '<td data-title="Producto">' . htmlspecialchars($row['producto_nombre']) . '</td>';
                echo '<td data-title="Proveedor">' . htmlspecialchars($row['proveedor']) . '</td>';                echo '<td data-title="Precio">' . htmlspecialchars($row['precio_producto']) . '</td>';
                ...
                if ($row['estado'] === 'pendiente') {
                    echo '<button class="btn-autorizar" data-id="' . htmlspecialchars($row['id']) . '" data-estado="autorizado">Autorizar</button>';
                    echo '<button class="btn-rechazar" data-id="' . htmlspecialchars($row['id']) . '" data-estado="rechazado">Rechazar</button>';
                } else {
