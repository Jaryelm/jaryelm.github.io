            ...
            <div class="content-data">
                ...
                <form method="GET" action="" class="rrhh-filter-row">
                        ...
                        <div class="rrhh-filter-actions">
                            ...
                            <a href="pruebas_psicometricas_usr.php" class="pabtn rrhh-btn-inline">Limpiar</a>
                        </div>
                </form>
            </div>
        </div>
        ...
        <div class="data">
            <div class="content-data">
                ...
                <div class="table-responsive" style="overflow-x:auto;">
                    <?php
                    $data = medidata_rrhh_fetch_postulantes("p.status = 'Pruebas Psicometricas'", $id_vacante);
                    ?>
                    <?php if(count($data) > 0): ?>
