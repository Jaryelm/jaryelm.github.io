...
<form method="POST" >
    ...
    <div class="container-modal">
        <div class="content-modal">
            ...
            <hr>
            <br>
            <label for="email"><b>Plan DX</b></label><span class="badge-warning">*</span>

            <textarea  name="trat" id="trat" required placeholder="Escribe Tratamiento.." style="height:200px"></textarea>
