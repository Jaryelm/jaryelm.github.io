...
try {
    $sql = "UPDATE rrhh_custom_events SET title = ?, start_date = ?, start_time = ?, end_date = ?, end_time = ?, color = ?, id_event_type = ?, description = ?, all_day = ?, is_public = ?, recurrence = ?, recurrence_until = ? WHERE id = ? AND deleted = 0";
