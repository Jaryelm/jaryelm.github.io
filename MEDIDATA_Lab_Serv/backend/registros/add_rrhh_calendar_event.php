...
try {
    $sql = "INSERT INTO rrhh_custom_events (title, start_date, start_time, end_date, end_time, color, created_by, id_event_type, description, all_day, id_user, is_public) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
