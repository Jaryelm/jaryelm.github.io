...
if (isset($_POST['add_appointment'])) {
    ...
    if (!$timeObject) {
        ...
        Swal.fire("Error!", "La hora de inicio no es válida.", "error").then(function() {
    ...
    if (!$startDateTime) {
        ...
        echo '<script type="text/javascript">
        Swal.fire("Error!", "La fecha y hora de inicio no son válidas.", "error").then(function() {
            window.location = "../../frontend/citas/nueva.php";
        });
        </script>';
        exit();
    ...
    if (strtotime($start) > strtotime($end)) {
        ...
        echo '<script type="text/javascript">
        Swal.fire("Error!", "La fecha final debe ser igual o posterior a la inicial.", "error").then(function() {
            window.location = "../../frontend/citas/nueva.php";
        });
        </script>';
        exit();
    ...
    if (!$exists) {
        ...
        echo '<script type="text/javascript">
        Swal.fire("Error!", "El área de servicio seleccionada no es válida.", "error").then(function() {
            window.location = "../../frontend/citas/nueva.php";
        });
        </script>';
        exit();
...
VALUES(
    ...
    if ($sql->execute()) {
        ...
        if ($lastInsertId > 0) {
            ...
            echo '<script type="text/javascript">
            Swal.fire("¡Registrado!", "Se reservó la cita correctamente", "success").then(function() {
            ...
            echo '<script type="text/javascript">
            Swal.fire("Error!", "No se pueden agregar datos, comuníquese con el administrador.", "error").then(function() {
                window.location = "../../frontend/citas/nueva.php";
            });
            </script>';
        }
        ...
        echo '<script type="text/javascript">
        Swal.fire("Error!", "Error en la consulta, comuníquese con el administrador.", "error").then(function() {
            window.location = "../../frontend/citas/nueva.php";
        });
        </script>';
    }
