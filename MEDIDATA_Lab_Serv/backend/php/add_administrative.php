...
try {
    ...
    $stmt = $connect->prepare(
        'INSERT INTO staff_administrative (id_user, numide, nomadm, apeadm, nacadm, fecha_ingreso, sexadm, cargo, state)
         VALUES (:id_user, :numide, :nomadm, :apeadm, :nacadm, :fecha_ingreso, :sexadm, :cargo, \'1\')'
    );
    $ok = $stmt->execute([
        ':id_user' => $idUser,
        ':numide' => $numide,
