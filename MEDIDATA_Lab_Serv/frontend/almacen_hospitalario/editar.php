...
<h1 class="title"><?php echo $saludo . ', <strong>' . $name . '</strong>'; ?></h1>
            ...
            <button class="button" onclick="location.href='../almacen/compra_unificada.php'">Registro de Nuevo Producto al Inventario</button>
