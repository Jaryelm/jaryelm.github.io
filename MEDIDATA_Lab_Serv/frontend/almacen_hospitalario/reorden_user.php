...
<script>
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "options += '<option value=\"{$row['idprcd']}\" data-stock=\"{$row['stock']}\" data-price=\"{$row['preprd']}\" {$disabled} style=\"{$style}\">{$row['nompro']} (Stock: {$row['stock']}, Precio: LPS. {$row['preprd']})";
...
<style>
 ...
 <?php include_once '../../backend/php/reorden_solicitudes.php' ?>
</body>
</html>
