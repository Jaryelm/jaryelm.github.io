...
<section id="content">
    ...
    <main>
        ...
        <div class="table-title">
            ...
            <button class="button" onclick="window.location.href='requisiciones.php'">
                ...
                <tbody>
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        if ($row['estado'] === 'pendiente') {
                            echo '<button onclick="aprobarRequisicion(' . $row['id'] . ')" class="btn-aprobar" title="Aprobar">
                                    <i class="bx bx-check"></i>
                                  </button>';
                            echo '<button onclick="rechazarRequisicion(' . $row['id'] . ')" class="btn-rechazar" title="Rechazar">
                                    <i class="bx bx-x"></i>
                                  </button>';
                        }
                        echo '</td>';
...
function verDetalles(id) {
    $.ajax({
        url: 'obtener_detalles_requisicion.php',
        type: 'POST',
        data: { id: id },
