...
<form action="../../backend/php/add_medicine_hospitalario.php" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
...
<label for="codpro"><b>Código de Producto</b></label>
...
function calcularPrecioVenta() {
 ...
 <?php include_once '../../backend/php/add_medicine_hospitalario.php' ?>
</body>
</html>
