...
<section id="content">
    ...
    <main>
        ...
        <button class="button" onclick="cambiarColor(this, 'reporte_compras_detalladas_user.php')">Compras Detalladas</button>
...
function aplicarFiltros() {
    ...
    var url = 'reporte_compras_detalladas_user.php';
    if (params.length) url += '?' + params.join('&');
    window.location.href = url;
}

function limpiarFiltros() {
    window.location.href = 'reporte_compras_detalladas_user.php';
}
</script>
</body>
</html>
