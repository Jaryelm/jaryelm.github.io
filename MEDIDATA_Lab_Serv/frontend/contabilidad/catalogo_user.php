...
<body>
    <div id="catalogo-cuentas" class="container">
        <!-- Sección de Registro de Catálogo -->
        <div class="form-section">
            <h2>Nueva Cuenta</h2>
            <form id="registro-form">
                <label for="tipo-cuenta">Tipo Cuenta: <span class="required">*</span></label>
                <select id="tipo-cuenta" name="tipo-cuenta" class="select2 catalogo-tipo-select" required>
    ...
    <form id="actualizar-form">
        ...
        <select id="tipo-cuenta-actualizar" name="tipo-cuenta-actualizar" class="select2 catalogo-tipo-select" required>
            <option value="" disabled selected>Seleccione Cuenta</option>
            <option value="activos">Activos</option>
            <option value="pasivos">Pasivos</option>
            <option value="capital">Capital</option>
        ...
        <label for="nuevo-nombre">Nuevo Nombre: <span class="required">*</span></label>
