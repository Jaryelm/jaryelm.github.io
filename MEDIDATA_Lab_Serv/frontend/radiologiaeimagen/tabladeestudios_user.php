...
<script>
    ...
    async function fetchStudies() {
        ...
        try {
            ...
            try {
                ...
                throw new Error(
                    (htmlLike ? 'El servidor devolvió HTML en lugar de JSON (404, error PHP o redirección). ' : '') +
    ...
    function viewSeries(seriesId) {
        ...
        const viewerUrl = `https://dev:Mrecords7@medicloud.medicasa.hn/orthanc/web-viewer/app/viewer.html?series=${seriesId}`;
