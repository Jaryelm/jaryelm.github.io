...
<a type="button" href="../pacientes/imprimir.php?id=<?php echo $d->idpa; ?>" class="button">Informe General</a>
...
<script>
    ...
    const url = `../pacientes/generate_signos_vitales_pdf.php?idpa=${idpa}`;
    ...
    function descargarPDFSignoVital(signoId) {
        ...
        if (!signoId) return;
        window.open('../pacientes/generate_signos_vitales_pdf.php?idpa=' + idpa + '&signo_id=' + signoId, '_blank');
    }
</script>
...
<script>
    function descargarHojaHospitalizacionPDF() {
        ...
        const url = `../pacientes/generate_hospitalizacion_pdf.php?idpa=${idpa}`; // Archivo PHP para generar el PDF de la hoja de hospitalización
        window.open(url, '_blank'); // Abrir el PDF en una nueva pestaña
    }
</script>
...
<script>
    function graftempPDF() {
        ...
        const url = `../pacientes/grafica_temp_pdf.php?idpa=${idpa}`;
...
function guardarDato() {
    ...
    $.post('../pacientes/save_temperatura.php', datos, function(response) {
        if (response.error) {
...
function cargarDatos() {
    ...
    $.get('../pacientes/fetch_temperatura.php', { idpa }, function(response) {
        if (response.error) {
            Swal.fire('Error', response.error, 'error');
        } else {
            let rows1 = '', rows2 = '';
...
function descargarPDFInsulinas() {
    const idpa = <?php echo $_GET['id']; ?>;
    const url = `../pacientes/generate_glucometrias_pdf.php?idpa=${idpa}`;
    window.open(url, '_blank');
}
...
function registrarGlucometrias() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/add_glucometrias.php",
        data: {
            fecha,
            turno,
            hora,
...
function cargarGlucometrias() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_glucometrias.php",
        data: { idpa },
        dataType: "json",
        success: function(response) {
            if (response.error) {
...
<button class="accordion">Control de Dieta</button>
<div class="panel">
    <br>
    <div class="table-header">
...
function descargarPDFDieta() {
    const idpa = <?php echo $_GET['id']; ?>;
    const url = `../pacientes/generate_dieta_pdf.php?idpa=${idpa}`;
    window.open(url, '_blank');
}
...
<script>
    ...
    $.ajax({
        type: 'POST',
        url: '../pacientes/add_ingestas.php',
        data: {
            idpa,
            fecha,
            hora,
...
<script>
    ...
    $.ajax({
        type: 'POST',
        url: '../pacientes/add_excretas.php',
        data: {
            idpa,
            fecha,
            hora,
...
function descargarPDFIngestas() {
    const idpa = <?php echo $_GET['id']; ?>;
    const url = `../pacientes/generate_ingestas_pdf.php?idpa=${idpa}`;
    window.open(url, '_blank');
}
</script>
...
function descargarPDFExcretas() {
    const idpa = <?php echo $_GET['id']; ?>;
    const url = `../pacientes/generate_excretas_pdf.php?idpa=${idpa}`;
    window.open(url, '_blank');
}
</script>
...
<script>
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_ingestas.php",
        data: { idpa },
        dataType: "json",
        success: function(response) {
            if (response.error) {
...
<script>
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_excretas.php",
        data: { idpa },
        dataType: "json",
        success: function(response) {
            if (response.error) {
...
function descargarPDFEvolucion() {
    const idpa = <?php echo $_GET['id']; ?>;
    const url = `../pacientes/generate_evolucion_pdf.php?idpa=${idpa}`;
    window.open(url, '_blank');
}
...
function registrarEvolucion() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/add_evolucion.php",
        data: {
...
function cargarEvolucion() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_evolucion.php",
        data: { idpa },
        dataType: "json",
        success: function(response) {
            if (response.error) {
...
function descargarPDFMedicamentos() {
    const idpa = <?php echo $_GET['id']; ?>;
    const url = `../pacientes/generate_medicamentos_pdf.php?idpa=${idpa}`;
    window.open(url, '_blank');
}
...
function registrarMedicamentos() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/add_medicamentos.php",
        data: {
...
function cargarMedicamentos() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_medicamentos.php",
        data: { idpa },
        dataType: "json",
        success: function(response) {
            if (response.error) {
...
function registrarAltaExigida() {
    ...
    $.ajax({
        type: "POST",
        url: ",,/pacientes/save_alta_exigida.php",
...
function cargarDatosAlta() {
    ...
    fetch(`../pacientes/fetch_motivo_alta.php?idpa=${idpa}`)
...
function descargarAltaExigidaPDF() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/check_motivo_alta.php",
        data: { idpa },
        dataType: "json",
        success: function (response) {
            if (response.success) {
                if (response.hasMotivo) {
                    ...
                    window.open(`../pacientes/generate_alta_pdf.php?idpa=${idpa}`, '_blank');
                } else {
...
function registrarSignosVitales() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/add_signos_vitales.php",
        dataType: "json",
        data: {
            fecha: fecha,
            hora: hora,
...
function cargarSignosVitales() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_signos_vitales.php",
        data: { idpa: idpa },
        dataType: "json",
...
$(document).ready(function() {
    ...
    $("#form").submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "../pacientes/add_ge.php", // Archivo backend
            data: {
                pa1: geidpa,
                nomp1: genopa,
...
<script type="text/javascript">
    function trata(){
       ...
       $.ajax({
                    ...
                    url: "../pacientes/add_trat.php", //el archivo al cual se enviaran
                    data:dataens,
                    cache: false,
                    success: function(result){
...
function getIdpa() {
    ...
    function registrarHospitalizacion() {
        ...
        $.ajax({
            type: "POST",
            url: "../pacientes/save_hospitalizacion.php",
            data: data,
            cache: false,
            success: function (response) {
    ...
    function actualizarVista() {
        ...
        $.ajax({
            type: "GET",
            url: `../pacientes/fetch_hospitalizacion.php?idpa=${idpa}`,
            cache: false,
            success: function (response) {
