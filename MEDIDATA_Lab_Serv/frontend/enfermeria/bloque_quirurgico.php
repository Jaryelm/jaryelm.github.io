...
<a type="button" href="../servicioalcliente/imprimir.php?id=<?php echo $d->idpa; ?>" class="button">Imprimir</a>
...
<script type="text/javascript">
    function enviarGasto() {
        ...
        $.ajax({
            type: "POST",
            url: "../servicioalcliente/add_gastos_quirofano.php",
            data: dataen,
            cache: false,
...
<script type="text/javascript">
    function enviarPostOperativo() {
        ...
        $.ajax({
            type: "POST",
            url: "../servicioalcliente/add_post_operatorio.php",
            data: dataen,
            cache: false,
            success: function (result) {
...
function enviarRecuperacion() {
    ...
    fetch("../servicioalcliente/add_recuperacion.php", {
        method: "POST",
        body: formData
    })
...
function enviarMedifarma() {
    ...
    // Enviar datos con Fetch API
    fetch("../servicioalcliente/add_medicamento_medifarma.php", {
        method: "POST",
        body: formData
    })
    .then(response => response.json())
