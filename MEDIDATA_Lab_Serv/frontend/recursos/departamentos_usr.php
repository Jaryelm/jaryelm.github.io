...
<?php include_once '../recursos_humanos/perfil.php'; ?>
        ...
        <button class="button" onclick="cambiarColor(this, 'departamentos_nuevo_usr.php')">Registrar Departamento</button>
        <button class="button" onclick="cambiarColor(this, 'departamentos_usr.php')">Departamentos</button>
