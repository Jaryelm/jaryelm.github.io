...
<form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                <input type="hidden" name="return_page" value="enfermera_usr.php">
            <div class="containerss">
                <h1>Nuevo enfermero(a)</h1>
                ...
                <input type="text" name="nuriden" maxlength="14" placeholder="ejm: 0801199012345" required>
                
                <label><b>Nombres</b></label><span class="badge-warning">*</span>
                <input type="text" name="nurnam" placeholder="ejm: Juan Raúl" required>
                
                <label><b>Apellidos</b></label><span class="badge-warning">*</span>
                <input type="text" name="nurape" placeholder="ejm: Ramírez Requena" required>
