...
<button class="button" onclick="cambiarColor(this, '../../frontend/auxcontable/formulario_directorio.php')">Registrar Proveedores</button>
<button class="button" onclick="cambiarColor(this, '../../frontend/auxcontable/tabla_directorio.php')">Proveedores Médicos</button>
<button class="button" onclick="cambiarColor(this, '../../frontend/auxcontable/tabla_directorio_comercial.php')">Proveedores Comercial</button>
