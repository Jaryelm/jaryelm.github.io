    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="rrhh-tab-nav">
                ...
                <a href="lista_colaboradores_medifarma.php" class="button tab-button active">Lista Medifarma</a>
            ...
            <div class="data">
                <div class="content-data">
                    ...
                    $rrhh_lista_add_url = 'agregar_colaborador.php?contexto=medifarma';
