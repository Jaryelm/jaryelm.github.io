                    ...
                    <table id="example" class="responsive-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="editable-cell" data-id="<?php echo (int) $d->idsg; ?>" data-field="num_empleado" data-table="staff_general_services" data-idcol="idsg" contenteditable="true" style="background-color: #f9f9f9; border: 1px dashed #ccc; cursor: pointer;" title="Haz clic para editar"><?php echo htmlspecialchars($d->num_empleado ?? 'â€”'); ?></td>
                                ...
                                <td class="editable-cell" data-id="<?php echo (int) $d->idsg; ?>" data-field="cuenta_bac" data-table="staff_general_services" data-idcol="idsg" contenteditable="true" style="background-color: #f9f9f9; border: 1px dashed #ccc; cursor: pointer;" title="Haz clic para editar"><?php echo htmlspecialchars($d->cuenta_bac ?? 'â€”'); ?></td>
                                <td class="editable-cell" data-id="<?php echo (int) $d->idsg; ?>" data-field="fecha_ingreso" data-table="staff_general_services" data-idcol="idsg" contenteditable="true" style="background-color: #f9f9f9; border: 1px dashed #ccc; cursor: pointer;" title="Ej: 2024-01-30"><?php echo htmlspecialchars($d->fecha_ingreso ?? 'â€”'); ?></td>
                                <td class="editable-cell" data-id="<?php echo (int) $d->idsg; ?>" data-field="telefono" data-table="staff_general_services" data-idcol="idsg" contenteditable="true" style="background-color: #f9f9f9; border: 1px dashed #ccc; cursor: pointer;" title="Haz clic para editar"><?php echo htmlspecialchars($d->telefono ?? 'â€”'); ?></td>
                                <td><?php echo htmlspecialchars(($d->correo_personal ?? 'â€”') . ' / ' . ($d->correo_institucional ?? 'â€”')); ?></td>
                                <td><?php echo htmlspecialchars($d->nacsg); ?></td>
                                <td class="editable-cell" data-id="<?php echo (int) $d->idsg; ?>" data-field="id_biometrico" data-table="staff_general_services" data-idcol="idsg" contenteditable="true" style="background-color: #f9f9f9; border: 1px dashed #ccc; cursor: pointer;" title="Haz clic para editar"><?php echo htmlspecialchars($d->id_biometrico ?? 'â€”'); ?></td>
                                <td class="editable-cell" data-id="<?php echo (int) $d->idsg; ?>" data-field="num_locker" data-table="staff_general_services" data-idcol="idsg" contenteditable="true" style="background-color: #f9f9f9; border: 1px dashed #ccc; cursor: pointer;" title="Haz clic para editar"><?php echo htmlspecialchars($d->num_locker ?? 'â€”'); ?></td>
                                <td>
