    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="rrhh-tab-nav">
                ...
                <a href="lista_colaboradores_medicos.php" class="button tab-button active">Lista de Médicos</a>
            ...
            <div class="data">
                <div class="content-data">
                    <?php
                    $rrhh_lista_titulo = 'Lista Médicos';
                    $rrhh_lista_add_url = 'agregar_colaborador.php?contexto=medicos';
                    $rrhh_lista_add_label = 'Agregar médico';
