...
<section id="content">
    ...
    <main>
        ...
        <button class="button" onclick="cambiarColor(this, 'niveles_salariales_usr.php')">Listar Niveles</button>
        <button class="button" onclick="cambiarColor(this, 'registrar_nivel_salarial_usr.php')">Registrar Nuevo Nivel</button>
                ...
                <form id="salaryForm" action="../../backend/php/<?php echo $is_edit ? 'upd' : 'add'; ?>_salary_level.php" method="POST" autocomplete="off">
                    ...
                    <div class="containerss">
                        ...
                        <div style="display: flex; gap: 15px; margin-top: 30px; align-items: center;">
                            ...
                            <a href="niveles_salariales_usr.php" class="pabtn" style="flex: 1; margin: 0; text-align: center; text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 15px;">Cancelar</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            success: function(response) {
                if (response.success) {
                    Swal.fire('¡Éxito!', response.message, 'success').then(function() {
                        window.location = 'niveles_salariales_usr.php';
                    });
                } else {
