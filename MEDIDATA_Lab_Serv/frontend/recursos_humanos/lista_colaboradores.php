...
if (!isset($_SESSION['rol']) || $_SESSION['rol'] != 'Administrador') {
    header('Location: lista_colaboradores_usr.php');
    exit;
}
    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="rrhh-tab-nav" style="margin-bottom: 20px; display: flex; flex-wrap: wrap; gap: 10px;">
                <a href="lista_colaboradores.php?area=colaboradores" class="button tab-button <?php echo $filtro_area == 'colaboradores' ? 'active' : ''; ?>">Colaboradores</a>
