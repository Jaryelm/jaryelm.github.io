    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="rrhh-tab-nav" style="margin-bottom: 20px; display: flex; flex-wrap: wrap; gap: 10px;">
                <a href="lista_colaboradores_usr.php?area=colaboradores" class="button tab-button">Colaboradores</a>
                <a href="lista_colaboradores_usr.php?area=medico" class="button tab-button">Médicos</a>
                <a href="lista_excolaboradores_usr.php?area=colaboradores" class="button tab-button <?php echo $filtro_area == 'colaboradores' ? 'active' : ''; ?>">Excolaboradores</a>
                <a href="lista_excolaboradores_usr.php?area=medico" class="button tab-button <?php echo $filtro_area == 'medico' ? 'active' : ''; ?>">Ex Médicos</a>
                    ...
                    <div class="table-responsive" style="overflow-x:auto;">
                        ...
                        <table id="example" class="responsive-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span style="font-weight:bold; color:#035c67;"><?php
                                            $categoria_label = '';
                        ...
                        <div class="alert">
                            ...
                            <strong>Sin datos</strong> No hay excolaboradores registrados.
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
