    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="rrhh-tab-nav">
                ...
                <a href="lista_excolaboradores_usr.php" class="button tab-button active">Lista de Excolaboradores</a>
            </div>
            ...
            function loadCollaborators() {
                $.ajax({
                    ...
                    success: function(collaborators) {
                        ...
                        tbody.empty();
                        $('#colaboradores_head').html(RRHH_COLAB.headRow(RRHH_RO));

                        if (!Array.isArray(collaborators)) {
                            tbody.append('<tr><td colspan="' + RRHH_COLAB.colCount(RRHH_RO) + '">No se pudieron cargar los colaboradores.</td></tr>');
                            return;
                        }
                        ...
                        collaborators.forEach((collaborator) => {
                            ...
                            tbody.append(RRHH_COLAB.bodyRow(collaborator, counter++, RRHH_RO));
                        });
