                ...
                <form id="scheduleForm" action="../../backend/php/<?php echo $is_edit ? 'upd' : 'add'; ?>_schedule.php" method="POST" autocomplete="off">
                    ...
                    <div class="containerss">
                        ...
                        <div style="display: flex; gap: 15px; margin-top: 30px; align-items: center;">
                            ...
                            <a href="horarios_usr.php" class="pabtn" style="flex: 1; margin: 0; text-align: center; text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 15px;">Cancelar</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            success: function(response) {
                if (response.success) {
                    Swal.fire('¡Logrado!', response.message, 'success').then(function() {
                        window.location = 'horarios_usr.php';
                    });
                } else {
