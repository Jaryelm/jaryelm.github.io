...
<?php
include_once '../it/menu.php'; // Menú principal
?>
...
<section id="content">
    <nav>
        ...
        <?php include_once '../it/perfil.php'; // Perfil del usuario ?>
    </nav>
...
<form action="" method="POST" autocomplete="off">
    <input type="hidden" name="return_page" value="nuevo_servicio_user.php">
    <div class="containerss">
        ...
        <select id="uso_servicio" name="uso_servicio" class="select2" style="width: 100%;" required>
            ...
            <option value="Fisoterapia">Fisoterapia</option>
        </select>
...
<select id="categoria_servicio" name="categoria_servicio" class="select2" required>
    ...
    <option value="Procedimiento Cirugia menor">Procedimiento Cirugia menor</option>
    <option value="Cirugia, Quirofano">Cirugia, Quirofano</option>
    <option value="UCI">UCI</option>
    <option value="Ambulancia">Ambulancia</option>
    <option value="Medico por llamado">Medico por llamado</option>
    <option value="Labor y Parto">Labor y Parto</option>
    <option value="Maternidad">Maternidad</option>
    <option value="Otorrinalringologia">Otorrinalringologia</option>
    <option value="Urologia">Urologia</option>
    <option value="Hematologia">Hematologia</option>
    <option value="Neumologia">Neumologia</option>
    <option value="Equipo Quirofano">Equipo Quirofano</option>
