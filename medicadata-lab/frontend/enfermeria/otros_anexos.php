...
function registrarAutorizacion() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/save_intervencion_quirurgica.php",
...
function cargarDatosAlta() {
    ...
    fetch(`../pacientes/fetch_autorizacion_quirurgica.php?idpa=${idpa}`)
...
function descargarAutorizacionPDF() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/check_autorizacion_quirurgica.php",
        data: { idpa },
        dataType: "json",
        success: function (response) {
            if (response.success) {
                if (response.hasData) {
                    ...
                    window.open(`../pacientes/autorizacion_quirurgica_pdf.php?idpa=${idpa}`, '_blank');
                } else {
...
function registrarProcedimiento() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/save_procedimiento.php",
...
function cargarDatosProcedimientos() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_procedimientos.php",
        data: { idpa },
        dataType: "json",
        success: function (response) {
            let content = '';
...
function descargarProcedimientosPDF() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/check_procedimientos.php",
        data: { idpa },
        dataType: "json",
        success: function (response) {
            if (response.success) {
                if (response.hasData) {
                    // Si existe un motivo, generar el PDF
                    window.open(`../pacientes/procedimientos_pdf.php?idpa=${idpa}`, '_blank');
                } else {
                    // Mostrar advertencia si no hay motivo guardado
...
function registrarAnexoReferencia() {
    ...
    $.ajax({
        type: "POST",
        url: "../pacientes/save_anexo_referencia.php",
        data,
        success: function(response) {
            if (response.success) {
                swal('Guardado', response.message, 'success').then(() => {
...
function cargarDatosAnexoReferencia() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/fetch_anexo_referencia.php",
        data: { idpa },
        dataType: "json",
        success: function(response) {
            if (response.success && response.data.length > 0) {
...
function descargarAnexoReferenciaPDF() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/check_anexo_referencia.php",
        data: { idpa },
        dataType: "json",
        success: function (response) {
            if (response.success) {
                if (response.hasData) {
                    // Si existe un motivo, generar el PDF
                    window.open(`../pacientes/anexo_ref_pdf.php?idpa=${idpa}`, '_blank');
                } else {
                    // Mostrar advertencia si no hay motivo guardado
                    swal('Advertencia', 'No se puede generar la hoja solicitada ya que no has registrado los datos para completar la solicitud.', 'warning');
                }
...
document.querySelectorAll("input, textarea").forEach(input => {
    ...
    $.ajax({
        type: 'POST',
        url: '../pacientes/add_transfusion.php',
        data: formData,
        processData: false,
        contentType: false,
        success: function (response) {
...
function descargarTransfusionPDF() {
    ...
    $.ajax({
        type: "GET",
        url: "../pacientes/check_transfusion_hemoderivados.php",
        data: { idpa },
        dataType: "json",
        success: function (response) {
            if (response.success) {
                if (response.hasData) {
                    // Si existe un motivo, generar el PDF
                    window.open(`../pacientes/generate_transfusión_hemoderivados.php?idpa=${idpa}`, '_blank');
                } else {
                    // Mostrar advertencia si no hay motivo guardado
                    swal('Advertencia', 'No se puede generar la hoja solicitada ya que no has registrado los datos para completar la solicitud.', 'warning');
                }
