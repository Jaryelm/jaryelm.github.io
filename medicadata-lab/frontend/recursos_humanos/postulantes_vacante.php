    ...
    <section id="content">
        ...
        <div class="data">
            <div class="content-data">
                ...
                <form class="search-container-inline" style="background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 4px 16px rgba(0,0,0,0.05); margin-bottom: 25px; display: flex; gap: 15px; align-items: center;">
