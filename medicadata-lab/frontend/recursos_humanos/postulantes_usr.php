            ...
            <div class="content-data">
                ...
                <form method="GET" action="" style="margin-bottom: 20px;">
                    <div style="display: flex; gap: 10px; align-items: flex-end;">
                        ...
                        <a href="postulantes_usr.php" class="button" style="background-color: #666; margin-bottom: 0;">Limpiar</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="table-responsive" style="overflow-x:auto;">
                    ...
                    try {
                        $query = "SELECT p.*, pt.name as vacancy_name 
                                  ...
                                  WHERE p.deleted = 0 AND p.status = 'En Espera'";
                                ...
                                <?php foreach($data as $d): ?>
                                    <tr>
                                        ...
                                        <td data-title="Disponibilidad">
                                            <?php echo $d->isAvailability ? '<span class="badge" style="background-color: green; color: white; padding: 2px 5px; border-radius: 3px;">Sí</span>' : '<span class="badge" style="background-color: red; color: white; padding: 2px 5px; border-radius: 3px;">No</span>'; ?>
                                        </td>
                                        <td>
