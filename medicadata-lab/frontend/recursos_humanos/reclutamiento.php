            ...
            <div class="content-data">
                ...
                <form method="GET" action="" style="margin-bottom: 20px;">
                    <div style="display: flex; gap: 10px; align-items: flex-end;">
                        ...
                        <a href="reclutamiento.php" class="button" style="background-color: #666; margin-bottom: 0;">Limpiar</a>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <tbody>
                                <?php foreach($data as $d): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Ver detalle" href="detalle_reclutamiento.php?id=<?php echo $d->id ?>" class="fa fa-eye"></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
