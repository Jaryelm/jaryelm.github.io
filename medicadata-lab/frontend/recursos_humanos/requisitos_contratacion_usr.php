...
<head>
    ...
    <title>MEDIDATA - Requisitos de Contratación</title>
</head>
<body>
            ...
            <div class="content-data">
                ...
                <form method="GET" action="" style="margin-bottom: 20px;">
                    <div style="display: flex; gap: 10px; align-items: flex-end;">
                        ...
                        <a href="requisitos_contratacion_usr.php" class="button" style="background-color: #666; margin-bottom: 0;">Limpiar</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="table-responsive" style="overflow-x:auto;">
                    ...
                    try {
                        $query = "SELECT p.*, pt.name as vacancy_name 
                                  ...
                                  WHERE p.deleted = 0 AND p.status = 'Llenando Expediente'";
                            ...
                            <tbody>
                                <?php foreach($data as $d): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Ver detalle" href="detalle_requisitos_contratacion_usr.php?id=<?php echo $d->id ?>" class="fa fa-eye"></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
