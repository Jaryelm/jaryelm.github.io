                            ...
                            <tbody>
                                <?php foreach($data as $d): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Editar" href="editar_puesto_trabajo.php?id=<?php echo $d->id ?>" class="fa fa-edit"></a>
                                            <a title="Ver detalles" href="detalle_puesto_trabajo.php?id=<?php echo $d->id ?>" class="fa fa-eye" style="margin-left: 10px;"></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
