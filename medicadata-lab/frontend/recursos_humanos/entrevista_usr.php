            ...
            <div class="content-data">
                ...
                <form method="GET" action="" style="margin-bottom: 20px;">
                    <div style="display: flex; gap: 10px; align-items: flex-end;">
                        ...
                        <a href="entrevista_usr.php" class="button" style="background-color: #666; margin-bottom: 0;">Limpiar</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="table-responsive" style="overflow-x:auto;">
                    ...
                    try {
                        $query = "SELECT p.*, pt.name as vacancy_name 
                                  ...
                                  WHERE p.deleted = 0 AND p.status = 'Entrevista'";
                            ...
                            <tbody>
                                <?php foreach($data as $d): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Ver detalle" href="detalle_entrevista_usr.php?id=<?php echo $d->id ?>" class="fa fa-eye"></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <?php else: ?>
                        <div class="alert">
                            ...
                            <strong>Aviso:</strong> No hay candidatos en etapa de entrevista registrados para esta selección.
                        </div>
                    <?php endif; ?>
                </div>
            </div>
