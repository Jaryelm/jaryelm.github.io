            ...
            <div class="content-data">
                ...
                <form method="GET" action="" style="margin-bottom: 20px;">
                    <div style="display: flex; gap: 10px; align-items: flex-end;">
                        ...
                        <a href="reclutamiento_usr.php" class="button" style="background-color: #666; margin-bottom: 0;">Limpiar</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="data">
            <div class="content-data">
                ...
                <div class="table-responsive" style="overflow-x:auto;">
                    <?php 
                    try {
                        // For recruitment, we show candidates in the initial active stages
                        $query = "SELECT p.*, pt.name as vacancy_name 
                                  ...
                                  WHERE p.deleted = 0 AND p.status IN ('En Espera', 'Entrevista', 'Pruebas Psicometricas')";
                                ...
                                <?php foreach($data as $d): ?>
                                    <tr>
                                        ...
                                        <td data-title="Solicitud Llenada">
                                            <?php 
                                            // Using has_filled_application if it exists, otherwise placeholder logic
                                        ...
                                        <td data-title="Estado"><?php echo htmlspecialchars($d->status) ?></td>
                                        <td>
                                            <a title="Ver detalle" href="detalle_reclutamiento_usr.php?id=<?php echo $d->id ?>" class="fa fa-eye"></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <?php else: ?>
                        <div class="alert">
                            ...
                            <strong>Aviso:</strong> No hay candidatos en proceso de reclutamiento registrados para esta selección.
                        </div>
                    <?php endif; ?>
                </div>
            </div>
