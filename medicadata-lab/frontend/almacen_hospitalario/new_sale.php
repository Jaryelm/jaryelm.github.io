    ...
    <main>
        ...
        <div class="data">
            <div class="content-data">
                ...
                <?php
                $stmt_servicios = $connect->prepare("SELECT * FROM servicios_hospital ORDER BY fecha_creacion DESC");
...
$(document).ready(function() {
    function configurarTabla(tablaId) {
        let table = $('#' + tablaId).DataTable({
            ...
            ordering: false, // Deshabilita ordenamiento
            info: false, // Oculta información como "Mostrando X de Y"
            searching: true, // Habilita búsqueda en todos los campos
            dom: 'Bfrtip',
        ...
        // Manejar la búsqueda individualmente por cada tabla
    ...
    // Configurar tablas de forma independiente
