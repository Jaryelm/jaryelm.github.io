...
<h1 class="title"><?php echo $saludo . ', <strong>' . $name . '</strong>'; ?></h1>
        ...
        <button class="button" onclick="cambiarColor(this, 'nuevo_usr.php')">Registrar Médicos</button>
        <button class="button" onclick="cambiarColor(this, 'mostrar_usr.php')">Médicos</button>
