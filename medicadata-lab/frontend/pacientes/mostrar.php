...
<h1 class="title"><?php echo $saludo . ', <strong>' . $name . '</strong>'; ?></h1>
            ...
            <button class="button" onclick="location.href='historial.php'">Expediente Clínico</button>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <a title="Actualizar" href="../pacientes/editar.php?id=<?php echo $d->idpa ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
                        <a title="Información" href="../pacientes/info.php?id=<?php echo $d->idpa ?>" class="btn btn-sm btn-info"><i class="fa fa-info"></i></a>
                        <a title="Historial médico" href="../pacientes/historia.php?id=<?php echo $d->idpa ?>" class="btn btn-sm btn-success"><i class="fa fa-stethoscope"></i></a>
                        <a title="Pagos" href="../pacientes/pago.php?id=<?php echo $d->idpa ?>" class="btn btn-sm btn-warning"><i class="fa fa-money"></i></a>
