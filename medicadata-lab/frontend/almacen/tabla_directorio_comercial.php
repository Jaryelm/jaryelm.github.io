...
<button class="button" onclick="cambiarColor(this, '../almacen/formulario_directorio.php')">Registrar Proveedores</button>
<button class="button" onclick="cambiarColor(this, '../almacen/tabla_directorio_comercial.php')">Proveedores Comercial</button>
