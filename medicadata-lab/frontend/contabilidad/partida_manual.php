...
/** Si el nombre quedó vacío (p. ej. Select2), lo toma del catálogo o del texto de la opción */
...
/** Una sola petición agrupada (simple=1) + DataTables en cliente: menos ROUNDTRIPS frente al pool MySQL que serverSide con varias consultas pesadas por draw. */
...
function cargarTablaPartidasManuales() {
    ...
    $.getJSON('get_partidas_manuales.php', paramsPartidasManualesCarga())
        .done(function(resp) {
            $('#partidasManualCargando').remove();
