/**
 * Lista de inventario (product): carga JSON e inicializa DataTables (misma UX que compras / otras tablas).
 * Requiere: jQuery, DataTables y plugins ya cargados antes de este script.
 */
(function ($) {
    'use strict';

    var DATA_URL = '../../backend/registros/tabla_almacen.php';
    ...
    function initInventarioTable(data) {
        ...
        if (!Array.isArray(data)) {
            console.error('tabla_almacen: respuesta no es un array', data);
