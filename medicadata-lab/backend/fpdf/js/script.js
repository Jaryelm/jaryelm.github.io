...
// Compatibilidad temporal: permite mantener llamadas legacy swal(...)
// mientras se migra progresivamente todo a Swal.fire(...)
if (typeof window !== 'undefined' && typeof window.swal !== 'function') {
    window.swal = function swalCompat(arg1, arg2, arg3) {
        if (!window.Swal || typeof window.Swal.fire !== 'function') {
            console.error('SweetAlert2 no está cargado. Incluye sweetalert2.min.js antes de usar swal().');
