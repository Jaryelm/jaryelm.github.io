                ...
                <table id="detallesTable" class="items-table">
                    <thead>
                        <tr>
                            ...
                            <th>Artículo</th>
                            <th>Existencia</th>
                            <th style="display: none;">Precio</th>  <!-- Ocultar columna -->
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td style="display: none;"><input type="text" id="costo" readonly class="form-control"></td>  <!-- Ocultar columna -->
                            <td>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (res.success) {
                    ...
                    .then(() => {
                        window.location.href = 'lista_requisiciones_user.php';
                    });
                } else {
