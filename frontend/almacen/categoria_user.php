            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td>
                <a title="Actualizar" href="categoria_editar.php?id=<?php echo $d->idcat ?>" class="fa fa-pencil tooltip"></a>
                            <a title="Información" href="categoria_info.php?id=<?php echo $d->idcat ?>" class="fa fa-info"></a>
