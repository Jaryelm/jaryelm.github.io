...
<button class="button" onclick="cambiarColor(this, '../../frontend/radiologiaeimagen/lista_transcripciones_user.php')">Transcriptores</button>
    ...
    document.getElementById('assignRadiologistForm').onsubmit = function(e) {
        ...
        // Preparar datos para enviar (mismo formato que worklist.php)
        const requestData = {
            study_id: studyId,
            radiologist_id: radiologistId,
            factura_id: null, // Sin factura para técnicos
            assignment_notes: '',
